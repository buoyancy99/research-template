...
class BaseLightningExperiment(BaseExperiment):
    ...
    def train(self) -> None:
        ...
        trainer = pl.Trainer(
            ...
            callbacks=callbacks,
            val_check_interval=self.cfg.experiment.validation.val_check_interval,
            limit_val_batches=self.cfg.experiment.validation.limit_val_batches,
            check_val_every_n_epoch=self.cfg.experiment.validation.check_val_every_n_epoch,
            ...
            num_sanity_val_steps=1 - int(self.cfg.experiment.debug),
        )
